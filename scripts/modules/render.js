import { getWeatherForecastData , convertPressure , calculateDewPoint, getCurrentDateTime, getwindDerection} from './utils.js';
...
export const renderWidgetOther = (widget, data) => {
     ...
     widget.insertAdjacentHTML(
        ...
        <p class="widget__wind-speed">${data.wind.speed} м/с</p>
          <p class="widget__wind-text">${getwindDerection(90)}</p>
...
export const renderWidgetForecast = (widget, data) => {
  ...
  const forecastData = getWeatherForecastData(data); // need write functionnnn!
